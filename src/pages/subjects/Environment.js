...
// Import the image
import shankarIasEnvironmentImage from "../../assets/shankariasenvironment.jpeg";
...
const Environment = () => {
  ...
  const BOOKS = [
    { name: "Shankar IAS Environment Book", path: "/shankarias", image: shankarIasEnvironmentImage },
