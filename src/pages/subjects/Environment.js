...
const Environment = () => {
  ...
  const BOOKS = [
    { name: "Shankar IAS Environment Book", path: "/shankarias" },
    ...
    <div className="h-screen bg-gray-900 text-white font-poppins overflow-hidden overscroll-none">
      ...
      <div className="pt-16 pb-10 px-4 sm:px-6 lg:px-8 w-full overflow-hidden">
        <div className="h-[calc(100vh-4rem)] w-full overflow-y-auto">
          {/* Enter Environment Battleground Button Section */}
          <div className="pt-8 pb-6 flex justify-center">
            <Link to="/environment-battleground" onClick={handleCardClick("/environment-battleground")}>
              <button
              ...
              >
                Enter Environment Battleground
              </button>
            </Link>
          </div>

          {/* Separator and Environment Books Header */}
          <div className="text-center mb-6">
            ...
            <h3 className="mt-2 text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-50 tracking-tight">
              Choose Your Environment Books
            </h3>
          </div>

          {/* Environment Books Section */}
