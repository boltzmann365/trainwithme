...
const CurrentAffairs = () => {
  ...
  const BOOKS = [
    { name: "Vision IAS December 2024", path: "/vision-ias-dec-2024" },
    ...
    <div className="h-screen bg-gray-900 text-white font-poppins overflow-hidden overscroll-none">
      ...
      <div className="pt-16 pb-10 px-4 sm:px-6 lg:px-8 w-full overflow-hidden">
        <div className="h-[calc(100vh-4rem)] w-full overflow-y-auto">
          {/* Enter Current Affairs Battleground Button Section */}
          <div className="pt-8 pb-6 flex justify-center">
            <Link to="/current-affairs-battleground" onClick={handleCardClick("/current-affairs-battleground")}>
              <button
              ...
              >
                Enter Current Affairs Battleground
              </button>
            </Link>
          </div>

          {/* Separator and Current Affairs Books Header */}
          <div className="text-center mb-6">
            ...
            <h3 className="mt-2 text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-50 tracking-tight">
              Choose Your Current Affairs Books
            </h3>
          </div>

          {/* Current Affairs Books Section */}
