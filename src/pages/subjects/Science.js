...
// Import the image with corrected path
import dishaIasScienceImage from "../../assets/dishaiasscience.avif";
...
const Science = () => {
  ...
  const BOOKS = [
    { name: "Disha IAS Science Book", path: "/disha-ias-science", image: dishaIasScienceImage },
