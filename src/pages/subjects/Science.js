...
const Science = () => {
  ...
  const BOOKS = [
    { name: "Disha IAS Science Book", path: "/disha-ias-science" },
    ...
    <div className="h-screen bg-gray-900 text-white font-poppins overflow-hidden overscroll-none">
      ...
      <div className="pt-16 pb-10 px-4 sm:px-6 lg:px-8 w-full overflow-hidden">
        <div className="h-[calc(100vh-4rem)] w-full overflow-y-auto">
          {/* Enter Science Battleground Button Section */}
          <div className="pt-8 pb-6 flex justify-center">
            <Link to="/science-battleground" onClick={handleCardClick("/science-battleground")}>
              <button
              ...
              >
                Enter Science Battleground
              </button>
            </Link>
          </div>

          {/* Separator and Science Books Header */}
