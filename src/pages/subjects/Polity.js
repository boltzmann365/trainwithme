...
import laxmikanthImage from "../../assets/laxmikanth.jpeg";
...
const Polity = () => {
  ...
  const BOOKS = [
    { name: "Laxmikanth", path: "/laxmikanth", image: laxmikanthImage },
  ];
  ...
  return (
    <div className="h-screen bg-gray-900 text-white font-poppins overflow-hidden overscroll-none">
      ...
      <div className="pt-16 px-4 sm:px-6 lg:px-8 w-full">
        {/* Laxmikanth Card Positioned Below Navbar in the Left Corner with Original Width */}
