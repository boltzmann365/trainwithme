...
const ShankarIas = () => {
  ...
  const chapterNumbers = {
    Ecology: "Chapter 1",
    "Functions of an Ecosystem": "Chapter 2",
    "Terrestrial Ecosystem": "Chapter 3",
    "Aquatic Ecosystem": "Chapter 4",
    "Environmental Pollution": "Chapter 5",
    "Renewable Energy": "Chapter 6",
    "Environmental Issues": "Chapter 7",
    "Environmental Impact Assessment": "Chapter 8",
    Biodiversity: "Chapter 9",
    "Indian Biodiversity": "Chapter 10",
    "Schedule Animals of WPA, 1972": "Chapter 11",
    "Animal Diversity of India": "Chapter 12",
    "Plant Diversity of India": "Chapter 13",
    "Marine Organism": "Chapter 14",
    "Protected Area Network": "Chapter 15",
    "Conservation Efforts": "Chapter 16",
    "Climate Change": "Chapter 17",
    "Ocean Acidification": "Chapter 18",
    "Ozone Depletion": "Chapter 19",
    "Impact of Climate Change – India": "Chapter 20",
    "Mitigation Strategies": "Chapter 21",
    "India and Climate Change": "Chapter 22",
    "Climate Change Organisations": "Chapter 23",
    Agriculture: "Chapter 24",
    "Acts and Policies": "Chapter 25",
    "Institution and Measures": "Chapter 26",
    "Environmental Organisations": "Chapter 27",
    "International Environmental Conventions": "Chapter 28",
    "Environment Issues and Health Effects": "Chapter 29",
    "Ramsar Wetland Sites in India": "Appendix I",
    "Tiger Reserves of India": "Appendix II",
    "Elephant Reserves in India": "Appendix III",
    "Mike Sites in India": "Appendix IV",
    "Biosphere Reserves": "Appendix V",
    "List of India’s Biosphere Reserves in UNESCO’s Map List": "Appendix VI",
    "Natural World Heritage Sites": "Appendix VII",
    "List of Sacred Groves": "Appendix VIII",
    "Mangrove Sites in India": "Appendix IX",
    "List of Key Activities and Likely Associated Air Pollutants": "Appendix X",
    "Respiratory Irritants and Toxic Chemicals": "Appendix XI",
  };
  ...
  const fetchSingleMCQ = async (chapter = null, questionIndex = 0, count = 1, retryCount = 0, forceGenerate = false) => {
    ...
    const query = chapterName === "entire-book"
      ? `Generate ${count} MCQ from the entire Shankar IAS Environment Book, covering environmental topics comprehensively. Ensure the MCQ spans diverse topics across the book’s content, supplemented by internet resources and general knowledge, avoiding repetition of topics from the previous ${index} questions.`
      : `Generate ${count} MCQ from ${chapterName} of the Shankar IAS Environment Book. Use the chapter content as the primary source, supplemented by internet resources and general knowledge to ensure uniqueness and depth.`;
