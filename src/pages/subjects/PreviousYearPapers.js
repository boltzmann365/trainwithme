...
// Import the image
import dishaIasPreviousYearPapersImage from "../../assets/dishaiaspreviousyearpapers.jpg";
...
const PreviousYearPapers = () => {
  ...
  const BOOKS = [
    { name: "Disha IAS Previous Year Papers", path: "/disha-ias-previous-year-paper", image: dishaIasPreviousYearPapersImage },
