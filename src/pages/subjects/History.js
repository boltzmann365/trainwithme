...
const History = () => {
  ...
  const TOPICS = [
    { name: "Tamilnadu History", path: "/history/tamilnadu" },
    { name: "Spectrum", path: "/history/spectrum" },
    { name: "Art and Culture", path: "/history/art-and-culture" },
  ];
    ...
    <div className="h-screen bg-gray-900 text-white font-poppins overflow-hidden overscroll-none">
      ...
      <div className="pt-16 pb-10 px-4 sm:px-6 lg:px-8 w-full overflow-hidden">
        <div className="h-[calc(100vh-4rem)] w-full overflow-y-auto">
          {/* Enter History Battleground Button Section */}
          <div className="pt-8 pb-6 flex justify-center">
            <Link to="/history-battleground" onClick={handleCardClick("/history-battleground")}>
              <button
              ...
              >
                Enter History Battleground
              </button>
            </Link>
          </div>

          {/* Separator and History Topics Header */}
